...
router.get('/thelist', function(req, res){
  ...
  var url = 'mongodb://localhost:27017/hackhcst';
...
router.post('/register', function(req, res){
    ...
    MongoClient.connect(url, function(err, db){
      if (err) {
        ...
        // Get the student data passed from the form
        var register1 = {username: req.body.username, password: req.body.password,
...
router.post('/login', function(req, res){
    ...
    MongoClient.connect(url, function(err, db){
      if (err) {
       ...
       collection.find({"password":b, "email":c}).toArray(function (err, result) {
       if (err) {
